...
import org.infodavid.commons.model.annotation.ModelObjectDeclaration;
 ...
 */
@ModelObjectDeclaration
@MappedSuperclass
public abstract class AbstractModelObject<K extends Serializable> implements ModelObject<K> {
     ...
     */
    protected AbstractModelObject(final AbstractModelObject<K> source) {
     ...
     */
    protected AbstractModelObject(final K id) {
        this.id = id;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof final ModelObject<?> other)) {
            return false;
        }
    ...
    /*
     * (non-javadoc)
     * @see org.infodavid.commons.model.ModelObject#getId()
     */
    @Override
    public K getId() {
        return id;
    ...
    /*
     * (non-javadoc)
     * @see org.infodavid.commons.model.ModelObject#getModificationDate()
     */
    @Override
    ...
    /*
     * (non-javadoc)
     * @see org.infodavid.commons.model.ModelObject#setCreationDate(java.util.Date)
     */
    @Override
    ...
    /*
     * (non-javadoc)
     * @see org.infodavid.commons.model.ModelObject#setId(java.io.Serializable)
     */
    @Override
    ...
    /*
     * (non-javadoc)
     * @see org.infodavid.commons.model.ModelObject#setModificationDate(java.util.Date)
     */
    @Override
