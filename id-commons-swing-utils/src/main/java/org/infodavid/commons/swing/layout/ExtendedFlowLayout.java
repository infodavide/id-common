package org.infodavid.commons.swing.layout;
...
public class ExtendedFlowLayout extends FlowLayout {
    ...
    private static final long serialVersionUID = 6366358308817102223L;
    ...
    /**
     * Constructs a new <code>FlowLayout</code> with the specified alignment and a default 5-unit horizontal and vertical gap.<br/>
     ...
     */
    public ExtendedFlowLayout(final int align) {
        super(align);
    }

    /**
     * Creates a new flow layout manager with the indicated alignment and the indicated horizontal and vertical gaps.<br/>
     * The value of the alignment argument must be one of <code>WrapLayout</code>, <code>WrapLayout</code>, or <code>WrapLayout</code>.
     * @param align the alignment value
     * @param hgap  the horizontal gap between components
     * @param vgap  the vertical gap between components
     */
    public ExtendedFlowLayout(final int align, final int hgap, final int vgap) {
    ...
    /**
     * Gets the preferred layout size.
     ...
     * @param preferredLayoutSize the new preferred layout size
     */
    public void setPreferredLayoutSize(final Dimension preferredLayoutSize) {
