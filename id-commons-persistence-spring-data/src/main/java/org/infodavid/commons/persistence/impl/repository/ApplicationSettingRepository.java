...
public interface ApplicationSettingRepository extends ApplicationSettingsDao, QueryCallbackRepository<ApplicationSetting, Long> {

    /*
     * (non-Javadoc)
     * @see org.infodavid.commons.persistence.dao.ApplicationSettingsDao#deleteByName(java.lang.String)
     */
    @Override
    @Transactional
    @Modifying
    ...
    default Page<ApplicationSetting> findAll(final Pagination pagination, final Restriction restriction) {
        return find(pagination, em -> RepositoryUtils.getInstance().find(ApplicationSetting.class, ApplicationSetting.class, em, null, pagination, restriction));
    }

    /*
     * (non-Javadoc)
     * @see org.infodavid.commons.persistence.dao.ApplicationSettingsDao#findByScope(java.lang.String)
     */
    @Override
