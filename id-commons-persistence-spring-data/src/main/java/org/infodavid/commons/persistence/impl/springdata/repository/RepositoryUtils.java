...
public class RepositoryUtils {
    ...
    public <K extends Serializable, T extends ModelObject<K>, R> Page<R> find(final Class<T> domainClass, final Class<R> targetClass, final EntityManager entityManager, final String sqlResultSetMapping, final Pagination pagination, final Restriction restriction) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <K extends Serializable, T extends ModelObject<K>, S extends T> List<S> save(final Class<? extends Repository<T, K>> type, final Repository<T, K> repository, final Iterable<S> entities) {
        if (entities == null) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <K extends Serializable, T extends ModelObject<K>, S extends T> S save(final Class<? extends Repository<T, K>> type, final Repository<T, K> repository, final S entity) {
        if (entity == null) {
            return null;
        }
