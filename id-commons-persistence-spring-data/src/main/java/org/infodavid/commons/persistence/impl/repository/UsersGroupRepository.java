...
public interface UsersGroupRepository extends UsersGroupDao, QueryCallbackRepository<UserGroup, Long> {
    ...
    /*
     * (non-Javadoc)
     * @see org.infodavid.commons.persistence.dao.UsersGroupDao#findReferences(org.infodavid.commons.model.query.Pagination, org.infodavid.commons.model.query.Restriction)
     */
    @Override
    default Page<EntityReference> findReferences(final Pagination pagination, final Restriction restriction) throws PersistenceException {
        return find(em -> RepositoryUtils.getInstance().find(UserGroup.class, EntityReference.class, em, "UserGroupReferenceSqlResultSetMapping", pagination, restriction));
    }
